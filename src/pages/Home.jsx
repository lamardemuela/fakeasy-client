    ...
    >
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems:"center", gap:"32px" }}>
        ...
        <Box
          ...
          sx={{ display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "flex-start", gap:"16px" }}
        >
          <Typography variant="h5" sx={{ fontSize: "64px", fontWeight: 800, width: "100%", textAlign: "left", lineHeight:"1" }}>
            Generate fake data easily
          </Typography>
          <Typography variant="body" sx={{ width: "100%", textAlign: "left" }}>
            Select a data category and start generating fictitious information
            for your testing and development needs.
          </Typography>
          <Button
            color="primary"
            variant="contained"
      ...
      >
        <Typography sx={{marginTop: "56px", fontWeight:"700"}} variant="h6"> Categories </Typography>
        <Box
          sx={{
            display: "flex",
            justifyContent: "center",
